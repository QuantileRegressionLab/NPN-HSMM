...
for(sim in 1:nsim){
  ...
  FP_1_glasso[sim] = sum(aaa$omega[,,min_FP_glasso] != 0 & theta[,,1] == 0) / 2
  FP_2_glasso[sim] = sum(aaa$omega[,,max_FP_glasso] != 0 & theta[,,2] == 0) / 2
  TFP_1_glasso[sim] = 1 - FP_1_glasso[sim] / (P*(P-1)/2 - P + 1)
  TFP_2_glasso[sim] = 1 - FP_2_glasso[sim] / (P*(P-1)/2 - P + 2)
  FN_1_glasso[sim] = sum(aaa$omega[,,min_FP_glasso] == 0 & theta[,,1] != 0) / 2
  FN_2_glasso[sim] = sum(aaa$omega[,,max_FP_glasso] == 0 & theta[,,2] != 0) / 2
...
matrix = cbind(t.time_glasso,t.iter_glasso,lambda_glasso,ARI_glasso,errorRate_glasso,M_1_glasso,M_2_glasso,FP_1_glasso,FP_2_glasso,TFP_1_glasso,TFP_2_glasso,FN_1_glasso,FN_2_glasso,TFN_1_glasso,TFN_2_glasso,p_geom_1,p_geom_2)
