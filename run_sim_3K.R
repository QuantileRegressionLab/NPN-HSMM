...
for(sim in 1:nsim){
  ...
  for(i in grid){
    j = j+1
    aaa = try(EM_HSMM(Y = Y, S = S, Par = Par_HSMM, M = M, sojourn.distribution = sojourn[b], lambda = i, pen_EBIC = 0.5, seed = 1, err = 1e-4, iterMax = 5e2))
    if (inherits(aaa, "try-error")) {
      ICL_HSMM[j] = Inf
    } else {
      ICL_HSMM[j] = aaa$ICL
    }
    bbb = try(EM_HMM(Y = Y, S = S, Par = Par_HMM, lambda = i, pen_EBIC = 0.5, seed = 1, err = 1e-4, iterMax = 5e2))
  ...
  aaa = EM_HSMM(Y = Y, S = S, Par = Par_HSMM, M = M, sojourn.distribution = sojourn[b], lambda = lambda_HSMM[sim], pen_EBIC = 0.5, seed = 1, err = 1e-4, iterMax = 5e2)
  bbb = EM_HMM(Y = Y, S = S, Par = Par_HMM, lambda = lambda_HMM[sim], pen_EBIC = 0.5, seed = 1, err = 1e-4, iterMax = 5e2)
  ...
  while(ARI_HSMM[sim] < 0.3 & iter < 10){
    ...
    ccc = EM_HSMM(Y = Y, S = S, Par = Par_HSMM, M = M, sojourn.distribution = sojourn[b], lambda = lambda_HSMM[sim], pen_EBIC = 0.5, seed = 1, err = 1e-4, iterMax = 5e2)
    if(ccc$loglik > llk){
      aaa = ccc
      llk = ccc$loglik
      ARI_HSMM[sim] = adjustedRandIndex(apply(aaa$u, 1, which.max), state)
  ...
  while(ARI_HMM[sim] < 0.3 & iter < 10){
    ...
    ccc = EM_HMM(Y = Y, S = S, Par = Par_HMM, lambda = lambda_HMM[sim], pen_EBIC = 0.5, seed = 1, err = 1e-4, iterMax = 5e2)
    if(ccc$loglik > llk){
      bbb = ccc
      llk = ccc$loglik
      ARI_HMM[sim] = adjustedRandIndex(apply(bbb$u, 1, which.max), state)
...
matrix = cbind(t.time_HSMM,t.time_HMM,t.iter_HSMM,t.iter_HMM,lambda_HSMM,lambda_HMM,ARI_HSMM,ARI_HMM,errorRate_HSMM,errorRate_HMM,M_1_HSMM,M_1_HMM,M_2_HSMM,M_2_HMM,M_3_HSMM,M_3_HMM,FP_1_HSMM,FP_1_HMM,FP_2_HSMM,FP_2_HMM,FP_3_HSMM,FP_3_HMM,TFP_1_HSMM,TFP_1_HMM,TFP_2_HSMM,TFP_2_HMM,TFP_3_HSMM,TFP_3_HMM,FN_1_HSMM,FN_1_HMM,FN_2_HSMM,FN_2_HMM,FN_3_HSMM,FN_3_HMM,TFN_1_HSMM,TFN_1_HMM,TFN_2_HSMM,TFN_2_HMM,TFN_3_HSMM,TFN_3_HMM,lambda_poi_1,lambda_poi_2,lambda_poi_3)
...
matrix = cbind(t.time_HSMM,t.time_HMM,t.iter_HSMM,t.iter_HMM,lambda_HSMM,lambda_HMM,ARI_HSMM,ARI_HMM,errorRate_HSMM,errorRate_HMM,M_1_HSMM,M_1_HMM,M_2_HSMM,M_2_HMM,M_3_HSMM,M_3_HMM,FP_1_HSMM,FP_1_HMM,FP_2_HSMM,FP_2_HMM,FP_3_HSMM,FP_3_HMM,TFP_1_HSMM,TFP_1_HMM,TFP_2_HSMM,TFP_2_HMM,TFP_3_HSMM,TFP_3_HMM,FN_1_HSMM,FN_1_HMM,FN_2_HSMM,FN_2_HMM,FN_3_HSMM,FN_3_HMM,TFN_1_HSMM,TFN_1_HMM,TFN_2_HSMM,TFN_2_HMM,TFN_3_HSMM,TFN_3_HMM,lambda_NB_1,lambda_NB_2,lambda_NB_3,p_NB_1,p_NB_2,p_NB_3)
...
matrix = cbind(t.time_HSMM,t.time_HMM,t.iter_HSMM,t.iter_HMM,lambda_HSMM,lambda_HMM,ARI_HSMM,ARI_HMM,errorRate_HSMM,errorRate_HMM,M_1_HSMM,M_1_HMM,M_2_HSMM,M_2_HMM,M_3_HSMM,M_3_HMM,FP_1_HSMM,FP_1_HMM,FP_2_HSMM,FP_2_HMM,FP_3_HSMM,FP_3_HMM,TFP_1_HSMM,TFP_1_HMM,TFP_2_HSMM,TFP_2_HMM,TFP_3_HSMM,TFP_3_HMM,FN_1_HSMM,FN_1_HMM,FN_2_HSMM,FN_2_HMM,FN_3_HSMM,FN_3_HMM,TFN_1_HSMM,TFN_1_HMM,TFN_2_HSMM,TFN_2_HMM,TFN_3_HSMM,TFN_3_HMM,p_geom_1,p_geom_2,p_geom_3)
